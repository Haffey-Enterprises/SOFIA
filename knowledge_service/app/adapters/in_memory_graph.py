...
#   never omitted from coverage measurement. RBT-78/R3a adds find_track_record
#   as a controllable candidate-record store (§4.2 A3): tests set the exact
#   records it returns, so the operation and read-discipline layers can be
#   exercised without modelling graph internals.
##############################################################################
