...
## Note on the 11 already-resolvable findings (run-025)

The eleven findings the arbiter already classified resolvable need no ruling — the author fixes them from their existing named authority (LAA/SA/coherence citation, tense, and cross-reference conformance). This addendum governs only the eight that were decision-bearing.
