...
- **Sibling (forward):** DDR-003 — feedback-loop governance (**ACCEPTED v1.0.0**); the architecture/governance split is settled (this DDR owns the data-path, DDR-003 owns governance).
...
|---|---|---|---|
| 1.6.0 | 2026-07-19 | RBT-14 | Pointer resolution — the Cross-References DDR-003 status marker resolves from forthcoming/unauthored to **ACCEPTED v1.0.0**, landed in this batch. Marker-level; no decision change. |
