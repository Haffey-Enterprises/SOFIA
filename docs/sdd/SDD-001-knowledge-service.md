...
- **Upstream implemented:** ADR-001 v1.1.0 · ADR-002 v1.1.0 · DDR-001 v1.3.0 · DDR-002 v1.2.0 · DDR-004 v1.0.0 (ACCEPTED-WITH-CONDITIONS — the §3.4.3 derivation's authority; six components: function form · constant treatment · Δt reference anchor · per-class declared-basis totality · composition boundary · calibration governance; §3.4.3). Built against DDR-002's safety-critical-tier contract per §7.2.
